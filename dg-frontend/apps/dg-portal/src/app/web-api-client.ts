...
export interface IIdentityClient {
    login(email: string | undefined, password: string | undefined, ipAddress: string | undefined): Observable<ResponseOfAuthenticationResponse>;
}
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ResponseOfAuthenticationResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResponseOfAuthenticationResponse>;
        }));
    }

    protected processLogin(response: HttpResponseBase): Observable<ResponseOfAuthenticationResponse> {
        ...
        if (status === 200) {
            ...
            result200 = ResponseOfAuthenticationResponse.fromJS(resultData200);
...
export class ResponseOfAuthenticationResponse implements IResponseOfAuthenticationResponse {
    succeeded?: boolean;
    message?: string;
    errors?: string[];
    data?: AuthenticationResponse;

    constructor(data?: IResponseOfAuthenticationResponse) {
        if (data) {
    ...
    static fromJS(data: any): ResponseOfAuthenticationResponse {
        data = typeof data === 'object' ? data : {};
        let result = new ResponseOfAuthenticationResponse();
        result.init(data);
        return result;
    }
...
export interface IResponseOfAuthenticationResponse {
    succeeded?: boolean;
    message?: string;
    errors?: string[];
    data?: AuthenticationResponse;
